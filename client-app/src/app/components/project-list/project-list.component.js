...
var ProjectListComponent = (function () {
    function ProjectListComponent(dataService, itemsService, notificationService, configService, loadingBarService) {
    ...
    ProjectListComponent.prototype.loadSchedules = function () {
        var _this = this;
        this.loadingBarService.start();
        this.dataService.getSchedules(this.currentPage, this.itemsPerPage)
            .subscribe(function (res) {
            _this.schedules = res.result; // project-list;
            _this.totalItems = res.pagination.TotalItems;
            _this.loadingBarService.complete();
        }, function (error) {
            _this.loadingBarService.complete();
            _this.notificationService.printErrorMessage('Failed to load project-list. ' + error);
        });
    };
    ProjectListComponent.prototype.pageChanged = function (event) {
    ...
    ;
    ProjectListComponent.prototype.removeSchedule = function (schedule) {
        var _this = this;
    ...
    ProjectListComponent.prototype.viewScheduleDetails = function (id) {
        var _this = this;
    ...
    ProjectListComponent.prototype.hideChildModal = function () {
...
], ProjectListComponent.prototype, "childModal", void 0);
__decorate([
...
//# sourceMappingURL=project-list-list.component.js.map
